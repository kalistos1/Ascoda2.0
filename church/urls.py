...
urlpatterns =[
    ...
    path('weekly_transaction/', views.calculate_weekly_transaction, name="weekly_transaction"),
    path('combined_offering/', views.calculate_combined_offering, name="combined_offering"),
