...
def calculate_combined_offering(request):
    ...
    specific_income_types = ['APPRECIATION', 'LOOSE_OFFERING', 'CHILD_DEDICATION', 'THANKS_OFFERING', 'SABBATH_SCHOOL_EXPENSE_OFFERING','ENVELOPE_OFFERING','INFANT_DEPT_OFFERING']
...
#                 sabbath=active_sabbath,
#                 church=church,
#                 income_type__in=['APPRECIATION', 'LOOSE_OFFERING', 'CHILD_DEDICATION', 'THANKS_OFFERING', 'SABBATH_SCHOOL_EXPENSE_OFFERING','ENVELOPE_OFFERING','INFANT_DEPT_OFFERING']
#             )
